...
const CodeViewer: React.FC<CodeViewerProps> = ({ activeLine }) => {
  return (
    <div className="hidden lg:flex w-80 bg-gray-900 border-l border-gray-800 p-6 flex-col gap-4 overflow-y-auto z-10">
      <h2 className="text-lg font-semibold text-gray-200">Code Execution</h2>
      <div className="flex-1 font-mono text-xs text-gray-400 whitespace-pre overflow-x-auto">
